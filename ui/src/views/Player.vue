<template>
  ...
  >
    <div class="player flex flex-col relative">
      ...
      <div
        class="xp-container relative bg-gray-700 p-4 pr-2 rounded-bl minw-12 self-start"
      >
        <StatBar text="XP" color="blue-500" />
      </div>
    </div>

    <Card>
      <template #title
        >Carrying ({{ player.pokemons.carrying.length }})</template
      >
      <PokemonList
